class FornecedoresController < ApplicationController
  ...
  def index
    ...
    @fornecedores_grid = initialize_grid(Fornecedor.order(:nome_fantasia),
        order: 'id')
  end
  ...
  private
    ...
    def fornecedor_params
      params.require(:fornecedor).permit(:razao_social, :nome_fantasia, :telefone, :endereco, :email, :cnpj)
    end
end
