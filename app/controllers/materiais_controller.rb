class MateriaisController < ApplicationController
  ...
  def index
    ...
    @materiais_grid = initialize_grid(Material,# :include => [:funcao, :telefones],
    order: 'id',
    name: 'u1',
  ...
  def create
    ...
    respond_to do |format|
      if @material.save
        format.html { redirect_to @material, notice: t('messages.cadastro_sucesso', :model => "Material") }
  ...
  private
    ...
    def material_params
      params.require(:material).permit(:descricao, :quantidade)
    end
end
